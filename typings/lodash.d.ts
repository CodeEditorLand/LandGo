...
declare module _ {
	...
	interface LoDashImplicitWrapperBase<T, TWrapper>
		extends LoDashWrapperBase<T, TWrapper> {}
	...
	interface LoDashImplicitStringWrapper
		extends LoDashImplicitWrapper<string> {}

	interface LoDashExplicitStringWrapper
		extends LoDashExplicitWrapper<string> {}
	...
	interface LoDashImplicitNumberArrayWrapper
		extends LoDashImplicitArrayWrapper<number> {}

	interface LoDashExplicitNumberArrayWrapper
		extends LoDashExplicitArrayWrapper<number> {}
	...
	interface LoDashStatic {
		 ...
		 **/
		flatten<T>(
			array: RecursiveList<T>,
			isDeep: boolean,
		): List<T> | RecursiveList<T>;
	}
	...
	interface LoDashImplicitObjectWrapper<T> {
		...
		pull<TValue>(
			...values: TValue[]
		): LoDashImplicitObjectWrapper<List<TValue>>;
	}
	...
	interface LoDashExplicitObjectWrapper<T> {
		...
		pull<TValue>(
			...values: TValue[]
		): LoDashExplicitObjectWrapper<List<TValue>>;
	}
	...
	interface LoDashImplicitArrayWrapper<T> {
		 ...
		 * @param whereValue _.where style callback
		 **/
		uniq<W>(whereValue: W): LoDashImplicitArrayWrapper<T>;
		 ...
		 * @param whereValue _.where style callback
		 **/
		unique<W>(whereValue: W): LoDashImplicitArrayWrapper<T>;
	}
	...
	interface LoDashImplicitArrayWrapper<T> {
		 ...
		 * @see _.every
		 */
		all<TObject extends {}>(predicate?: TObject): boolean;
	}
	...
	interface LoDashImplicitArrayWrapper<T> {
		 ...
		 * @see _.some
		 */
		any(predicate?: ListIterator<T, boolean>, thisArg?: any): boolean;
		 ...
		 * @see _.some
		 */
		any<TObject extends {}>(predicate?: TObject): boolean;
	}
	...
	interface LoDashImplicitObjectWrapper<T> {
		...
		collect<TValue, TResult>(
			iteratee?:
				| ListIterator<TValue, TResult>
				| DictionaryIterator<TValue, TResult>,
			thisArg?: any,
		): LoDashImplicitArrayWrapper<TResult>;
	...
	interface LoDashImplicitArrayWrapper<T> {
		 ...
		 * @see _.find
		 */
		detect<TObject extends {}>(predicate?: TObject): T;
	}
	...
	interface LoDashImplicitObjectWrapper<T> {
		 ...
		 * @see _.find
		 */
		detect<TObject extends {}, TResult>(predicate?: TObject): TResult;
	}
	...
	interface LoDashImplicitObjectWrapper<T> {
		...
		each<TValue>(
			iteratee?:
				| ListIterator<TValue, any>
				| DictionaryIterator<TValue, any>,
			thisArg?: any,
	...
	interface LoDashStatic {
		 ...
		 * @param pluckValue _.pluck style callback
		 **/
		indexBy<T>(collection: Array<T>, pluckValue: string): Dictionary<T>;
		 ...
		 * @param whereValue _.where style callback
		 **/
		indexBy<W, T>(collection: Array<T>, whereValue: W): Dictionary<T>;
	...
	interface LoDashImplicitArrayWrapper<T> {
		 ...
		 * @see _.some
		 */
		some(predicate?: ListIterator<T, boolean>, thisArg?: any): boolean;
	...
	interface LoDashStatic {
		 ...
		 **/
		where<T, U extends {}>(list: Array<T>, properties: U): T[];

		/**
		 * @see _.where
		 **/
		where<T, U extends {}>(list: List<T>, properties: U): T[];

		/**
		 * @see _.where
		 **/
		where<T, U extends {}>(list: Dictionary<T>, properties: U): T[];
	}
	...
	interface LoDashImplicitWrapper<T> {
		...
		after<TFunc extends Function>(
			func: TFunc,
		): LoDashImplicitObjectWrapper<TFunc>;
	}
	...
	interface LoDashExplicitWrapper<T> {
		...
		after<TFunc extends Function>(
			func: TFunc,
		): LoDashExplicitObjectWrapper<TFunc>;
	}
	...
	interface LoDashImplicitObjectWrapper<T> {
		 ...
		 * @see _.flowRight
		 */
		backflow<TResult extends Function>(
			...funcs: Function[]
		): LoDashImplicitObjectWrapper<TResult>;
	}
	...
	interface LoDashImplicitObjectWrapper<T> {
		...
		bind(
			thisArg: any,
			...args: any[]
		): LoDashImplicitObjectWrapper<(...args: any[]) => any>;
	}
	...
	interface LoDashImplicitObjectWrapper<T> {
		...
		bindKey(
			key: string,
			...args: any[]
		): LoDashImplicitObjectWrapper<Function>;
	}
	...
	interface LoDashImplicitObjectWrapper<T> {
		 ...
		 * @see _.flowRight
		 */
		compose<TResult extends Function>(
			...funcs: Function[]
		): LoDashImplicitObjectWrapper<TResult>;
	}
	...
	interface LoDashImplicitWrapper<T> {
		...
		createCallback(
			thisArg?: any,
			argCount?: number,
		): LoDashImplicitObjectWrapper<() => any>;
	}
	...
	interface LoDashImplicitObjectWrapper<T> {
		 ...
		 * @see _.flowRight
		 */
		flowRight<TResult extends Function>(
			...funcs: Function[]
		): LoDashImplicitObjectWrapper<TResult>;
	}
	...
	interface LoDashImplicitObjectWrapper<T> {
		 ...
		 * @see _.modArgs
		 */
		modArgs<TResult extends Function>(
			...transforms: Function[]
		): LoDashImplicitObjectWrapper<TResult>;
	...
	interface LoDashStatic {
		 ...
		 * @see _.negate
		 */
		negate<T extends Function, TResult extends Function>(
			predicate: T,
		): TResult;
	}
	...
	interface LoDashStatic {
		 ...
		 * @return Returns the new function.
		 */
		rearg<TResult extends Function>(
			func: Function,
			indexes: number[],
		): TResult;
	...
	interface LoDashStatic {
		 ...
		 * @see _.clone
		 */
		clone<T>(value: T, customizer?: (value: any) => any, thisArg?: any): T;
	}
	...
	interface LoDashImplicitWrapper<T> {
		 ...
		 * @see _.clone
		 */
		clone(customizer?: (value: any) => any, thisArg?: any): T;
	}
	...
	interface LoDashImplicitWrapper<T> {
		 ...
		 * @see _.cloneDeep
		 */
		cloneDeep(customizer?: (value: any) => any, thisArg?: any): T;
	}
	...
	interface LoDashImplicitArrayWrapper<T> {
		 ...
		 * @see _.max
		 */
		max<TObject extends {}>(whereValue?: TObject): T;
	}
	...
	interface LoDashImplicitObjectWrapper<T> {
		 ...
		 * @see _.max
		 */
		max<TObject extends {}, T>(whereValue?: TObject): T;
	}
	...
	interface LoDashImplicitArrayWrapper<T> {
		 ...
		 * @see _.min
		 */
		min<TObject extends {}>(whereValue?: TObject): T;
	}
	...
	interface LoDashImplicitObjectWrapper<T> {
		 ...
		 * @see _.min
		 */
		min<TObject extends {}, T>(whereValue?: TObject): T;
	}
	...
	interface LoDashImplicitObjectWrapper<T> {
		...
		sum<TValue>(
			iteratee:
				| ListIterator<TValue, number>
				| DictionaryIterator<TValue, number>,
			thisArg?: any,
		): number;
	...
	interface LoDashImplicitObjectWrapper<T> {
		...
		mapKeys<TResult, TKey>(
			iteratee?:
				| ListIterator<TResult, TKey>
				| DictionaryIterator<TResult, TKey>,
			thisArg?: any,
	...
	interface LoDashStatic {
		 ...
		 * @see _.merge
		 */
		merge<TObject, TResult>(object: TObject, ...otherArgs: any[]): TResult;
	}
	...
	interface LoDashExplicitWrapper<T> {
		...
		): LoDashExplicitObjectWrapper<TemplateExecutor>;
	}
	...
	interface LoDashImplicitWrapper<T> {
		...
		callback<TResult>(
			thisArg?: any,
		): LoDashImplicitObjectWrapper<(object: any) => TResult>;
	}
	...
	interface LoDashImplicitObjectWrapper<T> {
		...
		callback(
			thisArg?: any,
		): LoDashImplicitObjectWrapper<(object: any) => boolean>;
	...
	interface LoDashExplicitWrapper<T> {
		...
		callback<TResult>(
			thisArg?: any,
		): LoDashExplicitObjectWrapper<(object: any) => TResult>;
	}
	...
	interface LoDashExplicitObjectWrapper<T> {
		...
		callback(
			thisArg?: any,
		): LoDashExplicitObjectWrapper<(object: any) => boolean>;
	...
	interface LoDashImplicitWrapper<T> {
		 ...
		 * @see _.property
		 */
		property<TObj, TResult>(): LoDashImplicitObjectWrapper<
			(obj: TObj) => TResult
		>;
	}
	...
	interface LoDashExplicitWrapper<T> {
		 ...
		 * @see _.property
		 */
		property<TObj, TResult>(): LoDashExplicitObjectWrapper<
			(obj: TObj) => TResult
		>;
	}
	...
	interface LoDashImplicitObjectWrapper<T> {
		 ...
		 * @see _.propertyOf
		 */
		propertyOf(): LoDashImplicitObjectWrapper<
	...
	interface LoDashExplicitObjectWrapper<T> {
		 ...
		 * @see _.propertyOf
		 */
		propertyOf(): LoDashExplicitObjectWrapper<
			(path: string | string[]) => any
		>;
	}
